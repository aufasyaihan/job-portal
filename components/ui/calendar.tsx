    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                week: cn("flex w-full mt-2 gap-x-1", defaultClassNames.week),
                ...
                day: cn(
                    "relative w-full h-full p-0 text-center [&:last-child[data-selected=true]_button]:rounded-r-md group/day aspect-square select-none gap-4",
