                ...
                <CardContent className="flex flex-col gap-3">
                    ...
                    <div className="flex justify-between items-end">
                        <div className="flex flex-col gap-2">
                            <h3 className="font-bold text-lg text-neutral-100 capitalize">
                                {job.title}
                            </h3>
                        ...
                        <Link
                            href={`/admin/jobs/${job.id}?j=${job.title}`}
                        >
                          <Button variant="primary">
                            {job.job_list_card[0].cta}
                          </Button>
                        </Link>
                    </div>
                </CardContent>
...
export default function JobsPage() {
    return (
        <>
            <MainHeader />
            <div className="flex gap-6 px-[104px] py-10">
